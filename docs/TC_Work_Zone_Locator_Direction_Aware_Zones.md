...
- Lookahead calculation uses appropriate zone boundaries based on direction
...
## 11. AfterCare Integration (RC 1.4.0+)
...
- WHS Library documents and registry updates
- Updated documentation version to 1.35.0
...
- Added Cycle Timer feature
- Added AI direct chat mode
