      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        {!isOnline && (
          <div className="bg-amber-900/30 border border-amber-700 rounded-lg p-4 mb-6">
            ...
            <p className="text-sm text-amber-200/80">
              You&apos;re currently offline. Documents listed below are
          ...
          <>
            <div className="flex justify-between items-center mb-4">
              <p className="text-gray-400">
                {offlineDocs.length} document
                {offlineDocs.length !== 1 ? "s" : ""} saved
              </p>
              <Button
                variant="outline"
                size="sm"
        ...
        <div className="mt-8 p-4 bg-gray-800 rounded-lg border border-gray-700">
          ...
          <div className="space-y-2 text-sm text-gray-400">
            <p>
              📥 <strong className="text-gray-300">Save:</strong> Click the
              download button (📥) on any document to save it for offline
              access.
            </p>
            <p>
              💾 <strong className="text-gray-300">Access:</strong> Saved
              documents are marked with 💾 and available even when you&apos;re
              offline.
            </p>
            <p>
              ✕ <strong className="text-gray-300">Remove:</strong> Click the X
              button to remove a document from offline storage.
            </p>
            <p className="text-amber-400 mt-4">
              ⚠️ Offline storage is managed by your browser. Clearing browser
              data may remove saved documents.
            </p>
          </div>
        </div>
      </div>
