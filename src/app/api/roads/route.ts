...
async function getPavementData(
  ...
  const defaultResult = {
    ...
    width_m: null,
    cwy: 'Single',
    total_pave_width: null,
    total_seal_width: null,
    sealed_shoulder_l: null,
    sealed_shoulder_r: null,
    unsealed_shoulder_l: null,
    unsealed_shoulder_r: null,
    kerb_l: null,
    kerb_r: null,
  };
  ...
  if (!isOffline) {
    try {
      ...
      if (result.features && result.features.length > 0) {
        const attrs = result.features[0].attributes;
        return {
          lanes: attrs.NO_OF_LANES || null,
          width_m: attrs.TRAFFICABLE_SURF_WIDTH || null,
          cwy: attrs.CWY || 'Single',
          total_pave_width: attrs.TOTAL_PAVE_WIDTH || null,
          total_seal_width: attrs.TOTAL_SEAL_WIDTH || null,
          sealed_shoulder_l: attrs.SEALED_SHOULDER_L || null,
          sealed_shoulder_r: attrs.SEALED_SHOULDER_R || null,
          unsealed_shoulder_l: attrs.UNSEALED_SHOULDER_L || null,
  ...
  if (roadPavement && roadPavement.segments) {
    ...
    if (segment) {
      return {
        lanes: segment.lanes,
        width_m: segment.trafficable_width,
        cwy: segment.cwy || 'Single',
        total_pave_width: segment.total_pave_width,
        total_seal_width: segment.total_seal_width,
        sealed_shoulder_l: segment.sealed_shoulder_l,
        sealed_shoulder_r: segment.sealed_shoulder_r,
        unsealed_shoulder_l: segment.unsealed_shoulder_l,
  ...
  try {
    ...
    return NextResponse.json({
      ...
      pavement: {
        ...
        width_m: pavementData.width_m,
        cwy: pavementData.cwy,
        total_pave_width: pavementData.total_pave_width,
        total_seal_width: pavementData.total_seal_width,
        sealed_shoulder_l: pavementData.sealed_shoulder_l,
        sealed_shoulder_r: pavementData.sealed_shoulder_r,
        unsealed_shoulder_l: pavementData.unsealed_shoulder_l,
        unsealed_shoulder_r: pavementData.unsealed_shoulder_r,
