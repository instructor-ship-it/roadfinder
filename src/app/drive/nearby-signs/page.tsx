...
function NearbySignsContent() {
  ...
  // Wake Lock - Keep screen on while viewing nearby signs (driver likely still active)
  ...
  const allSigns = useMemo(() => {
    ...
    return [];
    // refreshKey is an intentional forced-invalidation trigger for IndexedDB re-reads
            ...
            <div key={jobId} className="bg-gray-800 rounded-lg overflow-hidden">
              ...
              <div className="bg-gray-700 px-3 py-2 flex justify-between items-center">
                ...
                <span className="text-xs text-gray-400">
                  {jobSigns.length} sign{jobSigns.length !== 1 ? 's' : ''}
                </span>
              </div>
              ...
              <div className="divide-y divide-gray-700">
                {jobSigns.map((sign) => {
                  ...
                  const mappedStatus: ComputedJobStatus =
                    status === 'placed'
                      ? 'active'
                      : status === 'maintained'
                        ? 'due-maintenance'
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-2">
                            <Button
                              ...
                              size="sm"
                              className="flex-1 bg-green-700 hover:bg-green-600 text-xs h-7"
                            >
                              Save
                            </Button>
                            <Button
                              ...
                              size="sm"
                              className="flex-1 bg-gray-600 hover:bg-gray-500 text-xs h-7"
                            >
                              Cancel
                            </Button>
                          </div>
