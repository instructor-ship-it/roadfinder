            ...
            <table className="w-full">
              ...
              <tbody className="text-gray-200 font-mono">
                ...
                <tr className="border-b border-gray-600">
                  ...
                  <td className="text-center">{sr1Slk.toFixed(2)} <span className="text-gray-500">(60/{sr1ZoneSpeed})</span></td>
                  <td className="text-center">{rnst2Slk.toFixed(2)} <span className="text-gray-500">(60/{rnstZoneSpeed})</span></td>
                </tr>
                <tr>
                  <td className="py-1.5 text-gray-400 flex items-center gap-2">
                  ...
                  <td className="text-center">{rwa1Slk.toFixed(2)} <span className="text-gray-500">{formatRwa(rwa1Speed)}</span></td>
                  <td className="text-center">{rwa2Slk.toFixed(2)} <span className="text-gray-500">{formatRwa(rwa2Speed)}</span></td>
                </tr>
              </tbody>
            </table>
          </div>
